...
const ScrollAreaUI = () => (
  <ScrollAreaPrimitive.Root className="h-full w-fit overflow-hidden">
    <ScrollAreaPrimitive.Viewport className="flex h-full w-full snap-x snap-proximity scroll-pl-12 items-center">
    ...
    <ScrollAreaPrimitive.Scrollbar className={scrollAreaTheme.bar.vertical} orientation="vertical">
...
const VerticalScrollArea = () => (
  <ScrollAreaPrimitive.Root className="h-[60vh] w-full overflow-hidden">
    <ScrollAreaPrimitive.Viewport className="h-full w-full snap-y snap-mandatory">
