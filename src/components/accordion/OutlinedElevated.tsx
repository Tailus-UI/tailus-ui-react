...
import { outlinedElevatedVariant as accordionTheme } from "@tailus/themer-accordion"

const AccordionOutlinedElevatedVariant = () => (
    <Accordion.Root className={`w-full min-w-[28rem] max-w-md ${accordionTheme.root}`} type="single" defaultValue="item-2">
...
export default AccordionOutlinedElevatedVariant;
