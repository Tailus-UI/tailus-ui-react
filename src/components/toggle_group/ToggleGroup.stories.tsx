...
type ToggleUIProps = {
  ...
  globalIntent: Intent,
  globalSize: Size,
  ItemOneVariant: Variant,
  ItemOneIntent: Intent,
  ItemTwoVariant: Variant,
  ItemTwoIntent: Intent
}
...
const ToggleGroupUI = (
  ...
  return (
    <ToggleGroupRoot intent={globalIntent} variant={globalVariant} size={globalSize} type="single" defaultValue="like"
      ...
      <ToggleGroupItem value="dislike" aria-label="I dislike it" variant={ItemTwoVariant} intent={ItemTwoIntent}>
        <ToggleGroupIconBefore>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
               strokeWidth={1.5} stroke="currentColor">
            <path
...
const meta: Meta<typeof ToggleGroupUI> = {
  title: 'ToggleGroup',
...
export const ToggleGroupExample2: Story = {
  ...
  render: args => (
    <div
      className="flex items-center gap-4 rounded-xl border border-gray-200 py-1 pl-4 pr-1 text-gray-700 dark:border-gray-900 dark:text-gray-300">
